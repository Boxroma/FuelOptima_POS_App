...
import io.grindallday.endrone_mobile_app.layouts.StartShiftLayout.StartShiftFragment;


public class StartShiftActivity extends AppCompatActivity {

    private ActivityStartShiftBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStartShiftBinding.inflate(getLayoutInflater());
